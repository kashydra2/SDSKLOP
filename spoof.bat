@echo off
title VJOJJAJISIOVCJIEWFU3ODIsDKIO1289UJFKGOMIODVLMKLDSJFKLH3KOHOLJJFMVOKAMS
cls

color 2

powershell.exe [console]::beep(800, 300)
powershell.exe [console]::beep(900, 300)
powershell.exe [console]::beep(1000, 200)


timeout 1 > nul
powershell.exe [console]::beep(300, 200)
echo [ ! ] STEP 1
timeout 1 > nul
cls
powershell.exe [console]::beep(300, 200)
...
echo [ ! ] STEP 4
timeout 3 > nul
powershell.exe [console]::beep(500, 200)
timeout 3 > nul
...
net session >nul 2>&1
if %errorLevel% neq 0 (
    echo execute with admin privilegies
    pause
    exit /b
)
...
del "%SCRIPT_DIR%spoof.bat" >nul 2>&1


powershell.exe [console]::beep(1200, 2000)
